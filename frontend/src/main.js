...
pluralCaseList.push( {plural: "receipts/receipts", pascal: "ReceiptReceipt"} )

pluralCaseList.push( {plural: "shops/shops", pascal: "ShopShop"} )

pluralCaseList.push( {plural: "vehicleparts/vehicleParts", pascal: "VehiclepartsVehicleParts"} )


pluralCaseList.push( {plural: "mechanics/mechanics", pascal: "MechanicMechanic"} )
